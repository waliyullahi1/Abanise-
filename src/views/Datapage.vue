        ...
        <div class="w-full md: md:w-1/2 sm:w-2/3 lg:max-w-md h-fit mx-4 shadows rounded-[1rem] ld text-2xl shadow bg-white" >
          <form @submit.prevent="prevTrans" action="" class="flex flex-col gap-5 h-fit p-8 text-xl font-semild">
            ...
            <div v-for="(field, index) in formFields" :key="index" >
              ...
              <select :id="field.name" v-model="formValues[field.name]" @input="onInput" :class="field.errorselection ? ' border-secondary':'  border-gray-500 '" class="w-full font-seibold rounded-[.2rem] ml-2 text-[17px] outline-none focus:border-primary border-gray-100 border-2 py-[.5rem]" >
              ...
              <div class="flex bg-white flex-col">
                ...
                <div class=" drop-shadow-md mt-2">
                    ...
                    <input type="number" v-model="form.phone" :class="errorphone ? ' border-secondary' : '  border-primary '" @input="onInput" class="w-full px-2 font-seibold rounded-[.2rem] ml-2 text-[17px] outline-none focus:border-primary border-gray-100 border-2 py-[.5rem]" placeholder="Recipients"/>
