  ...
  <div>
    ...
    <div  class="flex mt-10 gap-10 ">
        ...
        <div class=" w-full lg:w-2/5 mx-5 h-fit shadows rounded-[1rem] text-semibold text-2xl shadow bg-white ">
            ...
            <p class=" border-b-2 border-gray-300 text-primary py-5 pb-10 px-5 text-xl">To fund your wallet, please make a bank transfer of the desired amount to any of these Account details below. Your wallet will automatically be credited as soon as the bank transfer is successful. Please note these are your personal Vintage virtual account details. You are advised to save it as beneficiaries in your banking applications</p>
            <div class="py-5 px-5">
                <p class="font-normal text-3xl pt-10">Waheed </p>
                <p class="font-normal text-[19px] ">Wema Bank</p>
                <p class="font-normal text-[15px] ">23343543564</p>
            </div>
